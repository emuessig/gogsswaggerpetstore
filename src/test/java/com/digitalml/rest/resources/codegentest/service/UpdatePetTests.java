...
public class UpdatePetTests {
	...
	@Test
	public void testOperationUpdatePetBasicMapping()  {
		GogsSwaggerPetstoreServiceDefaultImpl serviceDefaultImpl = new GogsSwaggerPetstoreServiceDefaultImpl();
		UpdatePetInputParametersDTO inputs = new UpdatePetInputParametersDTO();
		inputs.setBody(new Pet());
		UpdatePetReturnDTO returnValue = serviceDefaultImpl.updatePet(fullyAutheticatedSecurityContext, inputs);
