...
public class FindPetsByTagsTests {

	@Test
	public void testOperationFindPetsByTagsBasicMapping()  {
		GogsSwaggerPetstoreServiceDefaultImpl serviceDefaultImpl = new GogsSwaggerPetstoreServiceDefaultImpl();
		FindPetsByTagsInputParametersDTO inputs = new FindPetsByTagsInputParametersDTO();
		inputs.setTags(new ArrayList<String>());
		FindPetsByTagsReturnDTO returnValue = serviceDefaultImpl.findPetsByTags(fullyAutheticatedSecurityContext, inputs);
